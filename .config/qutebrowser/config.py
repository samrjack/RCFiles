...
# To find documentation on all settings, see:
# https://qutebrowser.org/doc/help/

# This is here so setting changes done via the GUI are still loaded.
# To have GUI setting changes not loaded, pass the parameter False.
